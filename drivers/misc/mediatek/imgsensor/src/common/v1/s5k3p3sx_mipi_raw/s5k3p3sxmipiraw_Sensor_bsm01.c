...
#include "s5k3p3sxmipiraw_Sensor_bsm01.h"
...
{{ 4608, 3456,	  0,	  0, 4608, 3456, 2304, 1728, 0, 0, 2304, 1728, 0,	0, 2304, 1728}, // Preview
 ...
 { 4608, 3480, 1024, 1008, 2560, 1440, 1280,  720, 0, 0, 1280,  720, 0, 0, 1280,  720}, //hight speed video
 { 4608, 3456,  388,	652, 3840, 2160, 1920, 1080, 0, 0, 1920, 1080, 0,	0, 1920, 1080},// slim video
  { 4608, 3456,	  0,	  0, 4608, 3456, 4608, 3456, 0, 0, 4608, 3456, 0,	0, 4608, 3456}
 };
...
static void preview_setting(void)
{
  ...
  write_cmos_sensor(0x040A, 0x0002);
...
static void hs_video_setting(void)
{
  ...
  write_cmos_sensor(0x3D88, 0x0064);
  write_cmos_sensor(0x3D8A, 0x0068);
  write_cmos_sensor(0x0344, 0x0408);
...
static void slim_video_setting(void)
{
  ...
  write_cmos_sensor(0x3D88, 0x0064);
  write_cmos_sensor(0x3D8A, 0x0068);
  write_cmos_sensor(0x0344, 0x018C);
  write_cmos_sensor(0x0346, 0x029C);
  write_cmos_sensor(0x0348, 0x109B);
  write_cmos_sensor(0x034A, 0x0B0B);
  ...
  write_cmos_sensor(0x030A, 0x0001);
  write_cmos_sensor(0x0308, 0x0008);
  write_cmos_sensor(0x0342, 0x14A2);
  write_cmos_sensor(0x0340, 0x0DCE);
  write_cmos_sensor(0x0B0E, 0x0100);
  write_cmos_sensor(0x0216, 0x0000);
  write_cmos_sensor(0x6214, 0x7970);
  write_cmos_sensor_8(0x0100, 0x01);

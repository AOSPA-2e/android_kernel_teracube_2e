...
#if 1//defined(YK628_CUSTOMER_JIAHE_Z1_QHD_50)   // front camera use this
  #define OV5648_MIRROR_SET
#endif

static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = OV5648MIPI_SENSOR_ID,

    .checksum_value = 0x740fceb2,        //checksum value for Camera Auto Test 0xf7375923 cjc0428 chunmei
...
#if defined(OV5648_MIRROR_SET)
	#if defined (YK676_CUSTOMER_YAAOXING_F18_HDPLUS)
	.mirror = IMAGE_NORMAL,
	#else
    .mirror = IMAGE_HV_MIRROR,   // for mirror by xen 20150423
	#endif
#else
    .mirror = IMAGE_NORMAL,
#endif
                      ...
                      MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    spin_unlock(&imgsensor_drv_lock);
    preview_setting();
    set_mirror_flip(imgsensor.mirror); //sensor_config_data->SensorImageMirror); //added by xen 20150422
    return ERROR_NONE;
}    /*    preview   */

...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.checksum_value = 0xa11f4e23,//0x1b375588,        /*checksum value for Camera Auto Test*/
	...
	.isp_driving_current = ISP_DRIVING_6MA,//ISP_DRIVING_8MA,//ISP_DRIVING_6MA,	/* mclk driving current */
...
#if 1//defined(GC8034OTP_FOR_CUSTOMER)
...
static void gc8034_gcore_update_lsc(void)
{
	...
	//if (gc8034_otp_info.lsc_flag == 0x01) {

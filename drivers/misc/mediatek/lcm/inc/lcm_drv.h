...
typedef struct {
	...
	//xieen add for for show LCD module information begin,20170918
...
typedef struct {
	...
	void (*dsi_set_cmdq_V23)(void *cmdq, unsigned int cmd, unsigned char count, unsigned char *para_list, unsigned char force_update);	/* dual */
...
extern int get_lcd_id_state(void); //added by xen for getting LCD-ID pin state 20171106

#endif /* __LCM_DRV_H__ */

#else //BUILD_LK //xjl 20180531

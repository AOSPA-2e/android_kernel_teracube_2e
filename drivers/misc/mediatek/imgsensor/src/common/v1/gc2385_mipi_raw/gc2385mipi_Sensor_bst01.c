...
#include "gc2385mipi_Sensor_bst01.h"
...
static struct imgsensor_info_struct imgsensor_info = {
    ...
    .checksum_value = 0x7a06585a, //xjl 20190110 //0xf7375923,        //checksum value for Camera Auto Test
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x0a,0x04); //00
    ...
    write_cmos_sensor(0x1c,0x18);//10
	...
	write_cmos_sensor(0x02,0x8f);
	write_cmos_sensor(0x03,0xd0);//eo->d0
	...
	write_cmos_sensor(0x26,0x06);//08
	write_cmos_sensor(0x29,0x06);
	write_cmos_sensor(0x2a,0x08);
	write_cmos_sensor(0x2b,0x06);//08
	write_cmos_sensor(0xfe,0x00);
}    /*    sensor_init  */

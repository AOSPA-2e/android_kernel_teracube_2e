...
#define NON_STD_AC_CHARGER_CURRENT		200000
#else
...
#define MIN_CHARGE_TEMPERATURE  -40
#define MIN_CHARGE_TEMPERATURE_PLUS_X_DEGREE	-35
#define MAX_CHARGE_TEMPERATURE  90
#define MAX_CHARGE_TEMPERATURE_MINUS_X_DEGREE	88

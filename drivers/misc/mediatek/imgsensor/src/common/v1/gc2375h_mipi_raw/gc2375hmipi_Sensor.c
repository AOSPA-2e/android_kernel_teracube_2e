...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC2375HMIPI_SENSOR_ID,
	//.checksum_value = 0xf7375923,
	.checksum_value = 0x8726c936,// cjc add for smt
	.pre = {
		.pclk = 39000000,
		.linelength = 1040,
		.framelength = 1240,
 ...
 //define for dual camera by anxiang.xiao 20190102
	.custom1 = {
		.pclk = 39000000,
        .linelength = 1040,
        .framelength = 1560, //(1/24=exportime)/(linetime=1040/39000000)
        .startx = 0,
        .starty = 0,
        .grabwindow_width = 1600,
        .grabwindow_height = 1200,
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0xfe, 0x00);
	write_cmos_sensor(0xf7, 0x01);
    write_cmos_sensor(0xf8, 0x0c);//20
	write_cmos_sensor(0xf9, 0x42);
	write_cmos_sensor(0xfa, 0x88);
	write_cmos_sensor(0xfc, 0x8e);
	write_cmos_sensor(0xfe, 0x00);
	...
	write_cmos_sensor(0x02, 0x33);//0x33//0x55//37
...
static void preview_setting(void)
{
	LOG_INF("E\n");
	write_cmos_sensor(0xfe, 0x00);
	// write_cmos_sensor(0x17, 0xd6);//cjc add
...
static void capture_setting(void)
{
	LOG_INF("E\n");
	write_cmos_sensor(0xfe, 0x00);
	// write_cmos_sensor(0x17, 0xd7);//cjc add
	// write_cmos_sensor(0x4e, 0x3c);
	// write_cmos_sensor(0x4f, 0x00);
	// write_cmos_sensor(0x66, 0xc0);
	// write_cmos_sensor(0x67, 0x00);
...
//modify/define for dual camera by anxiang.xiao 20190102  ,need to check from vendor later 
#if 0

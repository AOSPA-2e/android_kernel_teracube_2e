...
#if defined(CONFIG_TERACUBE_2E)
     #define LCD_DEZHIXIN_ICNL9911S_HDPLUS_60
#endif 
...
#if defined(LCD_DEZHIXIN_ICNL9911S_HDPLUS_60) //xjl 20191023
...
#if defined(LCD_DEZHIXIN_ICNL9911S_HDPLUS_60)
        {0x26,1,{0x08}}, 
       {REGFLAG_DELAY, 5, {}},
#endif	   
...
#endif
{
	...
	memset(params, 0, sizeof(struct LCM_PARAMS));
...
#if defined(LCD_DEZHIXIN_ICNL9911S_HDPLUS_60) //xjl 20190924
		...
		params->dsi.horizontal_backporch				= 12;	//60;	//42;
		params->dsi.horizontal_frontporch				= 16;	//60;	//44;
		params->dsi.horizontal_active_pixel				= FRAME_WIDTH;

		params->dsi.PLL_CLOCK = 225;//208;	
#endif

...
#define LOG_1 pr_debug("OV4689,MIPI 2LANE\n")
/****************************   Modify end    *******************************************/
...
static struct imgsensor_info_struct imgsensor_info = {
    ...
    .pre = {
        ...
        .framelength = 1868, //1556 Jeff //1572,            //record different mode's framelength
    ...
    .hs_video = {
        ...
        .framelength = 1886,  //1572          //record different mode's framelength
        .startx = 0,                    //record different mode's startx of grabwindow
        .starty = 0,                    //record different mode's starty of grabwindow
...
static void set_shutter(kal_uint16 shutter)
{
    ...
    pr_debug("enter set_shutter, shutter =%d\n", shutter); 
...
#endif
    pr_debug("Exit!JEFF shutter =%d, framelength =%d\n", shutter,imgsensor.frame_length);
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	spin_unlock(&imgsensor_drv_lock);
	pr_debug("reg_gain = %d , reg_gain_h = 0x%x,reg_gain_l = 0x%x,\n ", reg_gain, reg_gain_l, reg_gain_h);
...
static void capture_setting(kal_uint16 currefps)
{
	...
	*/
		pr_debug("this is 15 fps capture setting\n");
	 write_cmos_sensor(0x0100,0x00);    // Sensor go to standby. MIPI stream off, both clock and data lane in LP11 mode
	...
	{
	        pr_debug("currefps:%d,  which mode set this framerate?\n",currefps);
		write_cmos_sensor(0x0100,0x00);    // Sensor go to standby. MIPI stream off, both clock and data lane in LP11 mode
...
UINT32 OV4689_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{

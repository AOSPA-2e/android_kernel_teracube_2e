...
#if defined(YK676_CUSTOMER_CAIFU_BSH18_HDPLUS)||defined(YK676_CUSTOMER_CAIFU_BSQ06_HDPLUS)||defined(YK673_CUSTOMER_CAIFU_S193_HD640)
#include "gc5025fmipi_Sensor_yk676_caifu_bsh18.h"//gc5025h
#else
...
//#if defined(KS907E_TUNE) //xen 20180518
...
static struct imgsensor_info_struct imgsensor_info = {
       ...
       .checksum_value = 0x68d49e6a,//0x56d1c29c,//0xf7375923,        //checksum value for Camera Auto Test
...
static void sensor_init(void)
{
	...
	/*MIPI*/                
	write_cmos_sensor(0xfe, 0x03);
	write_cmos_sensor(0x02, 0x07);//01  20170512 modify

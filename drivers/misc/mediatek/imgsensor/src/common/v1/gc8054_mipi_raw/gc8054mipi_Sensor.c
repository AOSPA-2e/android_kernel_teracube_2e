...
#include "gc8054mipi_Sensor.h"

/************************** Modify Following Strings for Debug **************************/
#define PFX "gc8054_camera_sensor"
#define LOG_1 LOG_INF("GC8054, MIPI 2LANE\n")
/****************************   Modify end    *******************************************/
#define GC8054_DEBUG    1
#if GC8054_DEBUG
...
static void tabel_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
...
/* 24M Mclk 30fps */
kal_uint16 gc8054_fullsize_addr_data[] = {
	/*system*/
	0x031c, 0x60,
	0x0320, 0xbb,
	0x0337, 0x05,
...
/* 24M Mclk 30fps */
kal_uint16 gc8054_binning_addr_data[] = {
	/*system*/
	0x031c, 0x60,
	0x0320, 0xbb,
	0x0337, 0x05,
	...
	0x0099, 0x00,
	0x0351, 0x00,
	0x0352, 0x04, //out_win_y1
	0x0353, 0x00,
	0x0354, 0x04, //out_win_x1
	0x034c, 0x06,
	0x034d, 0x60, //1632
	0x034e, 0x04,
	0x034f, 0xc8, //1224
...
kal_uint16 gc8054_preview_addr_data[] = {
	0x0102, 0x09,
};

kal_uint16 gc8054_capture_addr_data[] = {
	0x0102, 0x09,
};

kal_uint16 gc8054_normal_video_addr_data[] = {
	0x0102, 0x09,
};

kal_uint16 gc8054_hs_video_addr_data[] = {
	0x0102, 0x09,
};

kal_uint16 gc8054_slim_video_addr_data[] = {
	0x0102, 0x09,
};
...
{
	LOG_INF("E\n");
	tabel_write_cmos_sensor(gc8054_init_addr_data,
...
{
	LOG_INF("E\n");
	tabel_write_cmos_sensor(gc8054_binning_addr_data,
		sizeof(gc8054_binning_addr_data)/sizeof(kal_uint16));
	tabel_write_cmos_sensor(gc8054_preview_addr_data,
		sizeof(gc8054_preview_addr_data)/sizeof(kal_uint16));
}

static void capture_setting(void)
{
	LOG_INF("E\n");
	tabel_write_cmos_sensor(gc8054_fullsize_addr_data,
		sizeof(gc8054_fullsize_addr_data)/sizeof(kal_uint16));
	tabel_write_cmos_sensor(gc8054_capture_addr_data,
		sizeof(gc8054_capture_addr_data)/sizeof(kal_uint16));
}
...
static kal_uint32 set_test_pattern_mode(kal_bool enable)
{
	...
	if (enable) {
		write_cmos_sensor_8bit(0x008c, 0x11);
	} else {
		write_cmos_sensor_8bit(0x008c, 0x10);
	}
	spin_lock(&imgsensor_drv_lock);
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				pr_debug("[gc8054_camera_sensor]get_imgsensor_id:i2c write id: 0x%x, sensor id: 0x%x\n",
					imgsensor.i2c_write_id, *sensor_id);
				return ERROR_NONE;
			}
			pr_debug("[gc8054_camera_sensor]get_imgsensor_id:Read sensor id fail, write id: 0x%x, id: 0x%x\n",
				imgsensor.i2c_write_id, *sensor_id);
			retry--;
		} while (retry > 0);
		i++;

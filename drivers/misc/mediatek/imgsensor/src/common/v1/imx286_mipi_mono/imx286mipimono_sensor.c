...
#include "imx286mipimono_sensor.h"
...
static kal_uint16 IMX286MIPI_sensorGainMapping[IMX286MIPI_MaxGainIndex][2] = {
	{64, 0},
	{65, 6},
	{66, 12},
	{67, 20},
		...
		do {
			*sensor_id = return_sensor_id();
			...
			if  (*sensor_id == imgsensor_info.sensor_id){
				...
				*sensor_id = IMX286_MONO_SENSOR_ID;
...
UINT32 IMX286_MIPI_MONO_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{

...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5K3L6SEC_SENSOR_ID,

	//.checksum_value = 0x49c09f86,  0x6ed0b036
	.checksum_value = 0x87b07dea, //0xe249ffca, //xjl 20191209
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info =
 //Glenn added for 3L6SEC PDAF,20190131 
{
    .i4OffsetX = 28,
...
static kal_uint16 module_id=0xff;
static kal_uint16 read_otp_module_id(void)
{
	...
	AFRegulatorCtrl(0);
	AFRegulatorCtrl(1);
	 iReadRegI2C(pu_send_cmd, 2, (u8 *) &module_id, 1, EEPROM_WRITE_ID);
	 }
	 pr_debug("s5k3l6sec read_otp_module_id1: 0x%x \n",module_id);
	// return get_byte;
	return module_id;
}
...
UINT32 S5K3L6SEC_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{

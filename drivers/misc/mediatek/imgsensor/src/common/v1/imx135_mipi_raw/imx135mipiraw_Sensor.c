...
#define LOG_1 pr_debug("IMX135,MIPI 4LANE\n")
#define LOG_2 pr_debug("preview 2096*1554@30fps,864Mbps/lane; video 4196*3108@30fps,864Mbps/lane; capture 13M@30fps,864Mbps/lane\n")
/****************************   Modify end    *******************************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	#if defined(YK676_CUSTOMER_MEIHONG_V20_HDPLUS)||defined(YK686_CUSTOMER_YINMAI_S64390_HDPLUS)
...
static enum SENSOR_DPCM_TYPE_ENUM imgsensor_dpcm_info[10] =
...
static void ihdr_write_shutter_gain(kal_uint16 le, kal_uint16 se, kal_uint16 gain)
{
    ...
    if (imgsensor.ihdr_en) {
        ...
        write_cmos_sensor_8(0x0104, 0x00);
        pr_debug("[IMX135MIPI_IHDR_write_shutter_gain ] iRation:%d\n", iRation);
...
static void sensor_init(void)
{
    ...
    */
	...
	#if defined(YK676_CUSTOMER_MEIHONG_V20_HDPLUS)||defined(YK686_CUSTOMER_YINMAI_S64390_HDPLUS)
	 write_cmos_sensor(0x0101, 0x03);//0x03
	#else
                             ...
                             UINT8 *feature_para,UINT32 *feature_para_len)
{
    ...
    switch (feature_id) {
        ...
        case SENSOR_FEATURE_SET_SENSOR_OTP_AWB_CMD:
            //pr_debug("Update sensor awb from otp :%d\n", (BOOL)*feature_data);
            spin_lock(&imgsensor_drv_lock);
        ...
        case SENSOR_FEATURE_SET_SENSOR_OTP_LSC_CMD:
            //pr_debug("Update sensor lsc from otp :%d\n", (BOOL)*feature_data);
            spin_lock(&imgsensor_drv_lock);

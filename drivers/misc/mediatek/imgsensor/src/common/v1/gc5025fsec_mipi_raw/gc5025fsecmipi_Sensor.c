...
#include "gc5025fsecmipi_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
       .sensor_id = GC5025FSECMIPI_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h

       .checksum_value = 0x1c10cbe1,//0xf7375923,//0x56d1c29c,//0xf7375923,        //checksum value for Camera Auto Test

       .pre = {
             .pclk = 277333330,  //288000000  essam 0621                //record different mode's pclk
       ...
       .cap = {
             .pclk = 277333330,                //record different mode's pclk
             .linelength = 4800,                //record different mode's linelength
             .framelength = 2000,
             .startx = 0,
             .starty = 0,
...
static void gc5025h_gcore_initial_otp(void)
{
	...
	write_cmos_sensor(0xf8, 0x0f); //0x11 essam 0621
		...
		//if(m_SensorSel == 1) //xjl 20180615
		    //*sensor_id = GC5025MIPI_SENSOR_ID;
            	...
            	if (*sensor_id == GC5025MIPI_SENSOR_ID)
            	   *sensor_id = GC5025FSECMIPI_SENSOR_ID;
...
UINT32 GC5025FSECMIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
    /* To Do : Check Sensor status here */
    if (pfFunc!=NULL)
        *pfFunc=&sensor_func;
    return ERROR_NONE;
}    /*    GC5025FSECMIPI_RAW_SensorInit    */

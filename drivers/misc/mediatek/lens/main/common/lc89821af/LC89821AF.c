...
/*
 * LC89821AF voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "LC89821AF_DRV"
...
static signed short Hall_Max = 0x7fff;
static signed short Hall_Min = 0x8001;
#if 0
...
{
	return ((position * (unsigned short)(Hall_Max - Hall_Min) / 1024) +	Hall_Min) & 0xFFFF;
}
...
/* ////////////////////////////////////////////////////////////// */
long LC89821AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
	long i4RetValue = 0;
...
int LC89821AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
int LC89821AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
...
int LC89821AF_GetFileName(unsigned char *pFileName)
{

...
#include "hi1336fmipiraw_Sensor.h"

#define PFX "hi1336f_camera_sensor"
...
extern bool read_hi1336f_eeprom( kal_uint16 addr, BYTE *data, kal_uint32 size); 
...
static kal_uint16 hi1336f_table_write_cmos_sensor(
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_hi1336f[] = {
0x2000, 0x0021,
0x2002, 0x04a5,
0x2004, 0xb124,
0x2006, 0xc09c,
...
0x0202, 0x0200, //image orient  cjc 0x0100
...
{
#if MULTI_WRITE
	hi1336f_table_write_cmos_sensor(
		addr_data_pair_init_hi1336f,
		sizeof(addr_data_pair_init_hi1336f) /
		sizeof(kal_uint16));
#else
...
write_cmos_sensor(0x0202, 0x0200); //image orient cjc 0x0100
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_hi1336f[] = {
...
#if MULTI_WRITE
	hi1336f_table_write_cmos_sensor(
		addr_data_pair_preview_hi1336f,
		sizeof(addr_data_pair_preview_hi1336f) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_30fps_hi1336f[] = {
0x3250, 0xa060, //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
0x0730, 0x770f, //pll_cfg_mipi_a PLL_CLK=750mhz b7-6:00_isp_div2(1/1) 
...
kal_uint16 addr_data_pair_capture_15fps_hi1336f[] = {
	0x3250, 0xa060, //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 300) {
	hi1336f_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_hi1336f,
		sizeof(addr_data_pair_capture_30fps_hi1336f) /
		sizeof(kal_uint16));

	} else {
	hi1336f_table_write_cmos_sensor(
		addr_data_pair_capture_15fps_hi1336f,
		sizeof(addr_data_pair_capture_15fps_hi1336f) /
		sizeof(kal_uint16));
	}
#else
  if( currefps == 300) {
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_video_hi1336f[] = {
0x3250, 0xa060, //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
0x0730, 0x770f, //pll_cfg_mipi_a PLL_CLK=750mhz b7-6:00_isp_div2(1/1) 
0x0732, 0xe0b0, //pll_cfg_mipi_b b13-11:100_isp_div1(1/5) b10-8:000_mipi_div1(1/1) b1-0:00_mipi_div2(1/1) 
0x1118, 0x0006, //LSC r_win_y B[11]: Bit8 of y offset in start block when cropping. B[10:8] y start index of block when cropping. B[7:0] y offset in start block when cropping.
...
#if MULTI_WRITE
	hi1336f_table_write_cmos_sensor(
		addr_data_pair_video_hi1336f,
		sizeof(addr_data_pair_video_hi1336f) /
		sizeof(kal_uint16));
#else
write_cmos_sensor(0x3250, 0xa060); //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
write_cmos_sensor(0x0730, 0x770f); //pll_cfg_mipi_a PLL_CLK=750mhz b7-6:00_isp_div2(1/1) 
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_hi1336f[] = {
0x3250, 0xa060, //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
0x0730, 0x770f, //pll_cfg_mipi_a PLL_CLK=750mhz b7-6:00_isp_div2(1/1) 
...
#if MULTI_WRITE
	hi1336f_table_write_cmos_sensor(
		addr_data_pair_hs_video_hi1336f,
		sizeof(addr_data_pair_hs_video_hi1336f) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_hi1336f[] = {
0x3250, 0xa470, //sreg8 - RAMP,B[15:10]:d2a_ramp_rng_ctrl
0x0730, 0x770f, //pll_cfg_mipi_a PLL_CLK=750mhz b7-6:00_isp_div2(1/1) 
0x0732, 0xe1b0, //pll_cfg_mipi_b b13-11:100_isp_div1(1/5) b10-8:001_mipi_div1(1/2) b1-0:00_mipi_div2(1/1) 
...
#if MULTI_WRITE
	hi1336f_table_write_cmos_sensor(
		addr_data_pair_slim_video_hi1336f,
		sizeof(addr_data_pair_slim_video_hi1336f) /
		sizeof(kal_uint16));
#else
			...
			UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_SET_STREAMING_RESUME:
		...
		read_hi1336f_eeprom((kal_uint16)(*feature_data), 
				(char *)(uintptr_t)(*(feature_data+1)), 
				(kal_uint32)(*(feature_data+2)) );
...
UINT32 HI1336F_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc =  &sensor_func;
	return ERROR_NONE;
}	/*	HI1336F_MIPI_RAW_SensorInit	*/

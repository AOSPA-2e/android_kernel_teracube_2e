...
#if defined(YK736_CUSTOMER_YIZHANTONG_L5501_HD640) //zwl 20171206
#define _MIRROR_SET_
#endif
...
void GC0310_write_cmos_sensor(kal_uint8 addr, kal_uint8 para)
{
...
{   
    ...
    switch (para)
    {
        ...
        default:
			GC0310_write_cmos_sensor(0xfe, 0x00);	 
			GC0310_write_cmos_sensor(0xd3, 0x48);
			GC0310_write_cmos_sensor(0xfe, 0x00);
			Sleep(200);			
			break;
        //default:
...
void GC0310_MIPI_SetMaxFramerateByScenario(
...
void GC0310_MIPI_GetDefaultFramerateByScenario(
...
{
    struct SENSOR_EXIF_INFO_STRUCT* pExifInfo = (struct SENSOR_EXIF_INFO_STRUCT*)exifAddr;
...
void GC0310_Sensor_Init(void)
{
	...
	GC0310_write_cmos_sensor(0x01,0x03);             
	GC0310_write_cmos_sensor(0x02,0x33); //0x00);             
    ...
    GC0310_write_cmos_sensor(0x0c,0x04);//0x06
    ...
    #if defined(_MIRROR_SET_)
    GC0310_write_cmos_sensor(0x17,0x14);//bit[1][0]
    #else
    GC0310_write_cmos_sensor(0x17,0x17); //0x14 mirror
    #endif
	...
	GC0310_write_cmos_sensor(0x92,0x05); 
	GC0310_write_cmos_sensor(0x93,0x05); 
	GC0310_write_cmos_sensor(0x94,0x08); 
	GC0310_write_cmos_sensor(0x95,0x65);//0x76 pad 
    ...
    GC0310_write_cmos_sensor(0xcf,0xff);
        ...
        /////////////////////////////////////////////////
    GC0310_write_cmos_sensor(0xd0,0x40); 
    GC0310_write_cmos_sensor(0xd1,0x30); //0x34 pad
    GC0310_write_cmos_sensor(0xd2,0x30); //0x34 pad
	GC0310_write_cmos_sensor(0xd3,0x40); //0x48 pad
	GC0310_write_cmos_sensor(0xd5,0xf8); 
    ...
    GC0310_write_cmos_sensor(0x0b,0x01);
    GC0310_write_cmos_sensor(0x0c,0x00); 
    GC0310_write_cmos_sensor(0x12,0x52);
    GC0310_write_cmos_sensor(0x13,0x36); //0x48 pad
	GC0310_write_cmos_sensor(0x18,0x91);
	GC0310_write_cmos_sensor(0x19,0x95);
	...
	GC0310_write_cmos_sensor(0xa7, 0x95);
	GC0310_write_cmos_sensor(0xa9, 0xbc);
	GC0310_write_cmos_sensor(0xaa, 0x74);
	GC0310_write_cmos_sensor(0xab, 0x9d);
	GC0310_write_cmos_sensor(0xac, 0x80);
	GC0310_write_cmos_sensor(0xae, 0xb7);
	GC0310_write_cmos_sensor(0xaf, 0x9e);
	...
	GC0310_write_cmos_sensor(0x1c, 0x91);//pad add
	GC0310_write_cmos_sensor(0x21, 0x15);
	GC0310_write_cmos_sensor(0x50, 0x80);
	GC0310_write_cmos_sensor(0x56, 0x04);
	GC0310_write_cmos_sensor(0x59, 0x08);
	...
	GC0310_write_cmos_sensor(0x95,0x21); 
	GC0310_write_cmos_sensor(0x96,0xff); 
	GC0310_write_cmos_sensor(0x97,0x3f); 
	GC0310_write_cmos_sensor(0x98,0x21); 
	GC0310_write_cmos_sensor(0x9a,0x3f); 
	GC0310_write_cmos_sensor(0x9b,0x22); 
	GC0310_write_cmos_sensor(0x9c,0x63); 
	GC0310_write_cmos_sensor(0x9d,0x40); 
	...
	GC0310_write_cmos_sensor(0xa6,0xc9); 
	GC0310_write_cmos_sensor(0xa7,0x9d); 
	GC0310_write_cmos_sensor(0xa9,0xd4); 
	GC0310_write_cmos_sensor(0xaa,0x9d); 
	GC0310_write_cmos_sensor(0xab,0xb0); 
	GC0310_write_cmos_sensor(0xac,0x9c); 
	GC0310_write_cmos_sensor(0xae,0xc1); 
	GC0310_write_cmos_sensor(0xaf,0xb1); 
	GC0310_write_cmos_sensor(0xb0,0xc2); 
	GC0310_write_cmos_sensor(0xb1,0xa5); 
	...
	GC0310_write_cmos_sensor(0x8f,0x00); 
	GC0310_write_cmos_sensor(0xb8,0xd9); 
	GC0310_write_cmos_sensor(0xb9,0x86); 
        ...
        /////////////////////////////////////
    GC0310_write_cmos_sensor(0xfe,0x01);
	#if defined(YK628_CUSTOMER_JIAYE_D19_QHD_50)||defined(YK628_CUSTOMER_JIAYE_D12_QHD_50) 
	...
	#else
    GC0310_write_cmos_sensor(0xd0,0x2e);
	GC0310_write_cmos_sensor(0xd1,0xf8);
	GC0310_write_cmos_sensor(0xd2,0x08);
	GC0310_write_cmos_sensor(0xd3,0xe8);
	#endif
	...
	GC0310_write_cmos_sensor(0x26,0x6a); 
	  GC0310_write_cmos_sensor(0x27,0x04);
	GC0310_write_cmos_sensor(0x28,0x24);
	GC0310_write_cmos_sensor(0x29,0x05);
	GC0310_write_cmos_sensor(0x2a,0xcc);

			GC0310_write_cmos_sensor(0x2b,0x08);
			GC0310_write_cmos_sensor(0x2c,0xb2);
			GC0310_write_cmos_sensor(0x2d,0x09);
			GC0310_write_cmos_sensor(0x2e,0xf0);
...
static kal_uint32 GC0310GetSensorID(UINT32 *sensorID)
{
    int  retry = 3; 
...
#ifdef _MAIN2_CAM_SHELTER_DESIGN2_
	return ERROR_SENSOR_CONNECT_FAIL;
#endif
	Sleep(10);
...
BOOL GC0310_set_param_banding(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_FLICKER_MODE_60HZ:
			...
			GC0310_write_cmos_sensor(0x27, 0x03);   //exp level 0  20fps
			GC0310_write_cmos_sensor(0x28, 0x00); 
...
BOOL GC0310_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:	
			GC0310_write_cmos_sensor(0xfe, 0x01);
			GC0310_write_cmos_sensor(0x13, 0x36);//35//48 pad
			GC0310_write_cmos_sensor(0xfe, 0x00);
		break;
		...
		case AE_EV_COMP_10:
			GC0310_write_cmos_sensor(0xfe, 0x01);
			GC0310_write_cmos_sensor(0x13, 0x50);  // 48 to 60
			GC0310_write_cmos_sensor(0xfe, 0x00);
			Sleep(200);
		break;
		...
		case AE_EV_COMP_20:
			GC0310_write_cmos_sensor(0xfe, 0x01);
			GC0310_write_cmos_sensor(0x13, 0x58);
			GC0310_write_cmos_sensor(0xfe, 0x00);
		break;
		default:
		return FALSE;
...
void GC0310YUVSetVideoMode(UINT16 u2FrameRate)    // lanking add
{
...
void GC0310YUVSensorSetting(enum FEATURE_ID iCmd, UINT16 iPara)
{
    switch (iCmd) {
    case FID_AWB_MODE:
...
#if 1//defined (ATA_TEST) 
#if 0 // defined(YK602_CONFIG)  //20151107 ATA 
#define GC0310MIPI_TEST_PATTERN_CHECKSUM   (0x2c56685c) //xjl 20150919
#else
#define GC0310MIPI_TEST_PATTERN_CHECKSUM   (0x99a40e60) //(0xb9ea3dbf) //xjl 20150808
#endif
void GC0310MIPISetTestPatternMode(kal_bool bEnable)
{ 
    printk("[GC0310MIPISetTestPatternMode] Test pattern enable:%d\n", bEnable);

	if(bEnable)    // enable test pattern output  0809 ok!!!
	{
		//GC0310_write_cmos_sensor(0xfe, 0x00); 
        GC0310_write_cmos_sensor(0xfe, 0x00); 
		GC0310_write_cmos_sensor(0xfa, 0x11); //0x32 //42 //53
        GC0310_write_cmos_sensor(0x18, 0x06); //sdark
        GC0310_write_cmos_sensor(0x40, 0x08); //only intp enable
        GC0310_write_cmos_sensor(0x41, 0x00); //close all
        GC0310_write_cmos_sensor(0x42, 0x00); //close all
        GC0310_write_cmos_sensor(0x4f, 0x00); //add
        GC0310_write_cmos_sensor(0x77, 0x40); //AWB gain
        GC0310_write_cmos_sensor(0x78, 0x40); //AWB gain
        GC0310_write_cmos_sensor(0x79, 0x40); //AWB gain
        GC0310_write_cmos_sensor(0xd0, 0x40); //asde saturation
        GC0310_write_cmos_sensor(0xdd, 0x00); //AEC un
        GC0310_write_cmos_sensor(0x03, 0x00); //
        GC0310_write_cmos_sensor(0x04, 0x00); //0x01
        GC0310_write_cmos_sensor(0x71, 0x40); //AEC gain
        GC0310_write_cmos_sensor(0x72, 0x40); //AEC gain
        //GC0310_write_cmos_sensor(0xfe, 0x01); //ABS tilt
        //GC0310_write_cmos_sensor(0x9e, 0xc0); //ABS tilt
        //GC0310_write_cmos_sensor(0x9f, 0x40); //ABS stretch K
        //GC0310_write_cmos_sensor(0xfe, 0x00); //ABS stretch K
        GC0310_write_cmos_sensor(0x4c, 0x01); //test pattern
	}
	else
	{
		GC0310_write_cmos_sensor(0xfe,0x00);  
		GC0310_write_cmos_sensor(0x4c,0x00);
	}
        ...
        UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
    ...
    case SENSOR_FEATURE_SET_YUV_CMD:
        GC0310YUVSensorSetting((enum FEATURE_ID)*feature_data, *(feature_data+1));

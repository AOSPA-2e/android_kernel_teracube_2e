...
#define LOG_1 pr_info("OV4689,MIPI 2LANE\n")
/****************************   Modify end    *******************************************/
...
static void set_shutter(kal_uint16 shutter)
{
    ...
    pr_info("enter set_shutter, shutter =%d\n", shutter); 
...
#endif
    pr_info("Exit!JEFF shutter =%d, framelength =%d\n", shutter,imgsensor.frame_length);
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	spin_unlock(&imgsensor_drv_lock);
	pr_info("reg_gain = %d , reg_gain_h = 0x%x,reg_gain_l = 0x%x,\n ", reg_gain, reg_gain_l, reg_gain_h);
...
static void capture_setting(kal_uint16 currefps)
{
	...
	*/
		pr_info("this is 15 fps capture setting\n");
	 write_cmos_sensor(0x0100,0x00);    // Sensor go to standby. MIPI stream off, both clock and data lane in LP11 mode
	...
	{
	        pr_info("currefps:%d,  which mode set this framerate?\n",currefps);
		write_cmos_sensor(0x0100,0x00);    // Sensor go to standby. MIPI stream off, both clock and data lane in LP11 mode
